...
COMMANDS = [
    ...
    {"group": "Administration", "name": "relocate random", "usage": "relocate random", "who": "Administrateurs",
     "summary": "Déplace le château à un endroit choisi par le jeu, en consommant un relocalisateur aléatoire du sac.",
     "details": ["Une confirmation est toujours demandée : écrivez confirm dans les 60 secondes, ou cancel.",
                 "Seul l'administrateur qui a demandé l'action peut la confirmer.",
                 "Le bot dit ensuite où le château a atterri (ou que le serveur a refusé)."],
     "example": "relocate random"},
    {"group": "Administration", "name": "relocate", "usage": "relocate <x> <y>", "who": "Administrateurs",
     "summary": "Déplace le château aux coordonnées données, dans le royaume actuel, en consommant un relocalisateur avancé.",
    ...
    {"group": "Administration", "name": "confirm", "usage": "confirm", "who": "L'administrateur qui a demandé l'action",
     ...
     "example": "confirm"},
    {"group": "Administration", "name": "cancel", "usage": "cancel", "who": "Administrateurs",
     "summary": "Annule l'action en attente.", "example": "cancel"},
